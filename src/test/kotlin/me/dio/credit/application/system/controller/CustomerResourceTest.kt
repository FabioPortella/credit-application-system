...
class CustomerResourceTest {
    ...
    private fun builderCustomerDto(
        ...
        lastName: String = "Portella",
        cpf: String = "920.810.570-93",
        email: String = "ports@email.com",
        income: BigDecimal = BigDecimal.valueOf(10000.0),
        password: String = "1234",
        zipCode: String = "00000-00",
        street: String = "Rua Ports, 123",
    ) = CustomerDto(
        firstName = firstName,
        lastName = lastName,
        cpf = cpf,
    ...
    private fun builderCustomerUpdateDto(
        firstName: String = "Fábio Up",
        lastName: String = "Portella Up",
        income: BigDecimal = BigDecimal.valueOf(50000.0),
        zipCode: String = "11111-111",
        street: String = "Rua Ports Updated"
